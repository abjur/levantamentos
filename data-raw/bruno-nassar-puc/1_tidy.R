...
da_tidy <- da_bruta |>
  ...
  dplyr::transmute(
    ...
    dt_fato = lubridate::as_date(data_do_fato),
    hr_fato = horario_do_fato,
    parte_do_dia_fato = horario_do_fato_criterio_objetivo,
    dt_ip = data_da_instauracao_do_ip,
    dt_dist = data_da_distribuicao_do_processo,
    dt_denuncia = data_da_denuncia,
    dt_recebimento_denuncia = data_do_recebimento_da_denuncia,
    dt_pronuncia = data_da_decisao_de_pronuncia_impronuncia_ou_desclassificacao_na_primeira_fase,
    dt_plenario = data_da_sentenca_apos_plenario_absolvicao_sumaria_ou_extincao_da_punibilidade,
    suspensao = o_processo_chegou_a_ser_suspenso_com_base_no_art_366,
    dt_suspensao = data_da_decisao_que_determinou_a_suspensao,
    dt_revogacao_suspensao = data_da_decisao_que_revogou_a_suspensao_se_ha_decisao_expressa_nesse_sentido,
    ...
    dt_pris_prev = data_da_decisao_que_decretou_a_preventiva,
    liberdade = se_preso_o_reu_foi_colocado_em_liberdade,
    dt_soltura = data_da_decisao_que_determinou_a_soltura,
    ...
    pandemia_juro = ainda_nao_foi_designado_o_plenario_do_juri_em_razao_da_pandemia,
    fundamento_36,
    ...
    dt_acordao = data_do_acordao_do_tj_que_julgou_o_recurso,
    ...
    # continuar daqui
    de_acordo_com_a_sentenca_ha_conexao_do_crime_com_atividade_de_organizacao_criminosa,
    homicidio_simples_plenario,
    qualificadoras_plenario,
    causas_de_aumento_plenario,
    trata_se_de_reu_reincidente,
    homicidio_privilegiado,
    qual_foi_o_tempo_de_pena_aplicado,
    regime_inicial_de_cumprimento_de_pena,
    o_reu_pode_recorrer_em_liberdade,
    foi_interposto_recurso_contra_a_sentenca,
    quem_interpos_o_recurso,
    se_interposto_o_recurso_de_apelacao_ja_foi_julgado,
    data_do_acordao,
    resultado_do_acordao,
    se_alterada_a_pena_para_outro_patamar_informar_qual,
    se_alterado_o_regime_de_cumprimento_inicial_informar_qual,
    houve_sentenca_nulificada_no_curso_dos_autos,
    data_da_sentenca_nulificada,
    fundamento_68,
    qual_tribunal_nulificou_a_sentenca,
    data_do_acordao_que_nulificou_a_sentenca
  )
