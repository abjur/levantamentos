...
candidatos <- read_csv2("levantamentos/candidatos_sp_2020/consulta_cand_2020_SP.csv", 
...
prefeitos <- read_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/prefeitos_criminal.rds")
prefeitos %>% glimpse()
...
prefeitos %>% 
  ...
  write_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/prefeitos_criminal_passivo.rds")
...
prefeitos %>% 
  ...
  write_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/prefeitos_criminal_reus.rds")
...
vice <- read_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/vice_prefeitos_criminal.rds")
...
vice %>% 
  inner_join(ids_cpf_ok, c("cpf_candidato", "id_processo")) %>% 
  write_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/vice_prefeitos_criminal_passivo.rds")
...
vice %>% 
  inner_join(reus, c("cpf_candidato", "id_processo")) %>% 
  write_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/vice_prefeitos_criminal_reus.rds")
...
vereadores <- read_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/vereadores_criminal.rds")
...
vereadores %>% 
  inner_join(ids_cpf_ok, c("cpf_candidato", "id_processo")) %>% 
  write_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/vereadores_criminal_passivo.rds")
...
vereadores %>% 
  inner_join(reus, c("cpf_candidato", "id_processo")) %>% 
  write_rds("/mnt/dados/abj/levantamentos/candidatos_sp_2020/vereadores_criminal_reus.rds")
